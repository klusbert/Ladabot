  ...
  public partial class Client
    {
         ...
         public Client(Process pr)
        {
            ...
            this.m_spellList = new SpellList();
        ...
        public void PrepereClient()
        {
            ...
            m_inventory = new NewInventory(this);
     ...
     public DatReader DatReader
      ...
      public int Hunger
        {
            get
            {
                return Memory.ReadInt32(Addresses.Client.Hunger);
            }
        }
      public TimeSpan HungerTime
      {
          get
          {
              return TimeSpan.FromMinutes(Hunger);
          }
      }
      ...
      public int Ping
        ...
        public override string ToString()
        {
            ...
            if (Status == Constants.LoginStatus.LoggedIn)
            {
                return Player.Name;
            }
            else {
