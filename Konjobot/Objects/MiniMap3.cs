   ...
   public  class MiniMap3
    {
       ...
       public bool ProcessDirections(IEnumerable<MyPathNode> path)
       {
           myPath = path.ToList();
           WalkThread = new Thread(new ThreadStart(Process));
           WalkThread.Start();
           return true;
       }
