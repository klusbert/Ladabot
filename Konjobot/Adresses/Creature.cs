...
namespace KonjoBot.Adresses
{
        static class Creature
            ...
            public static uint DistanceX = 44;
            public static uint DistanceY = 40;
            public static uint DistanceZ = 36;
            public static uint DistanceScreenOffsetHoriz = 52;
            public static uint DistanceFaceDirection = 56;
            public static uint DistanceScreenOffsetVert = 48;
            public static uint DistanceIsWalking = 80;
            public static uint DistanceWalkDirection = 84;
            ...
            public static uint DistanceIsBlocking = 148;
      
            public static uint DistanceSkull = 152;
            public static uint DistanceParty = 156;
            public static uint DistanceWarIcon = 168;
            public static uint DistanceIsVisible = 172;
