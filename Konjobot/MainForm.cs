...
namespace KonjoBot
{
    public partial class MainForm : Form
    {
        ...
        public void DrawTile(Point p,bool blocking,string name,int speed)
        {
          if(blocking)
          {
        ...
        private void ParseGlobal(KonjoBot.Global ret)
        {
            ...
            foreach (Objects.Bot.HealingRule healingRule in ret.HealingRules)
